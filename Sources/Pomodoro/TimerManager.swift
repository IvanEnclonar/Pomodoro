...
class TimerManager: ObservableObject {
    ...
    var safeFocusDurationMinutes: Int {
        min(max(focusDurationMinutes, 1), 1440)
    }

    var safeShortBreakDurationMinutes: Int {
        min(max(shortBreakDurationMinutes, 1), 1440)
    }

    var safeLongBreakDurationMinutes: Int {
        min(max(longBreakDurationMinutes, 1), 1440)
    }

    var safeStreakMinMinutes: Int {
        min(max(streakMinMinutes, 1), 1440)
    }
