...
class TimerManager: ObservableObject {
    ...
    var safeFocusDurationMinutes: Int { max(1, min(focusDurationMinutes, 1440)) }
    var safeShortBreakDurationMinutes: Int { max(1, min(shortBreakDurationMinutes, 1440)) }
    var safeLongBreakDurationMinutes: Int { max(1, min(longBreakDurationMinutes, 1440)) }
    var safeStreakMinMinutes: Int { max(1, min(streakMinMinutes, 1440)) }
    var safeCompletionSound: String { Self.availableSounds.contains(completionSound) ? completionSound : "Ping" }
